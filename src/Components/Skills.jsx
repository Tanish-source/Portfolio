...
export default function Skills() {
    ...
    useEffect(() => {
        ...
        const highlightColors = ["#E24E1B", "#58E6D9", "#F79824", "#818D92", "#58BC5A", "#2176FF", "#B63E96", "#22AAA1"]
    ...
    return (
        <div className="w-full text-white min-h-screen">
            <h2 className="font-bold text-7xl sm:text-8xl pb-10 sm:pb-0 pt-40 lg:pt-80 w-full text-center px-4">
                Skills
            </h2>
            ...
            >
                ...
                <div className="hidden lg:block Grid relative mx-auto w-full h-[62%] border border-white/20">
                    <div className="Grid-row flex h-1/2">
                        <div className="Grid-items flex-1 flex justify-center items-center h-full border-r border-white/20">
                            <div className="flex flex-col gap-2 items-center justify-center relative z-[2]">
                                ...
                                <span className="text-4xl xl:text-5xl font-bold">MERN</span>
                            </div>
                        </div>
                        <div className="Grid-items flex-1 flex justify-center items-center h-full border-r border-white/20">
                        ...
                        <div className="Grid-items flex-1 flex justify-center items-center h-full border-r border-white/20">
                            <div className="relative z-[2] flex gap-2 items-center justify-center">
                                <i className="devicon-python-plain text-5xl xl:text-6xl"></i>
                                <span className="text-2xl xl:text-4xl font-bold">Python</span>
                            </div>
                        </div>
                        <div className="Grid-items flex-1 flex justify-center items-center h-full border-r border-white/20">
                            <div className="relative z-[2] flex gap-2 items-center justify-center">
                                <i className="devicon-amazonwebservices-plain-wordmark text-8xl xl:text-9xl"></i>
                            </div>
                        </div>
                        <div className="Grid-items flex-1 flex justify-center items-center h-full">
                            <div className="relative z-[2] flex gap-2 items-center justify-center">
                                <i className="devicon-threejs-original-wordmark text-8xl xl:text-9xl"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="Grid-row flex h-1/2 border-t border-white/20">
                        ...
                        <div className="Grid-items flex-1 flex justify-center items-center h-full border-r border-white/20">
                            <div className="relative z-[2] flex gap-2 items-center justify-center">
                                <i className="devicon-azuresqldatabase-plain text-7xl xl:text-8xl"></i>
                            </div>
                        </div>
                        <div className="Grid-items flex-1 flex justify-center items-center h-full border-r border-white/20">
                            <div className="relative z-[2] flex gap-2 items-center justify-center">
                                <i className="devicon-postgresql-plain-wordmark text-7xl xl:text-8xl"></i>
                            </div>
                        </div>
                        <div className="Grid-items flex-1 flex justify-center items-center h-full">
                            <div className="relative z-[2] flex flex-col gap-2 items-center justify-center">
                                <i className="devicon-github-original text-7xl xl:text-8xl"></i>
