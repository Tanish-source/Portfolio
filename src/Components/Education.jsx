...
const Details = ({ type, time, place, info }) => {
    ...
    return (
        <li ref={ref} className="my-8 first:mt-0 last:mb-0 md:w-[60%] sm:w-[70%] w-[80%] mx-auto flex flex-col items-center justify-between">
            ...
            >
                <h3 className="sm:text-2xl text-xl font-bold capitalize">
                    {type}
                </h3>
...
const Education = () => {
    ...
    return (
        <>
            <div className="my-40 sm:mb-80 mb-50">
                <h2 className="font-bold text-6xl sm:text-8xl sm:mb-32 mb-20 w-full text-center ">
                    Education
                </h2>
